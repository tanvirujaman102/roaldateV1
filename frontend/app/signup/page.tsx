          ...
          <div className="space-y-3 mb-6">
            ...
            >
              <FacebookLogin
                ...
                cssClass="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-4 rounded-lg transition duration-200 flex items-center justify-center space-x-2"
                icon="fa-facebook"
